...
echo lvac-lw
python vat_ladder.py --logdir logs/test/ --id lvac-lw --model clw --do_not_save --end_epoch 1 --decay_start 1.0 --which_gpu 0

echo lvan
python vat_ladder.py --logdir logs/test/ --id lvan --model n --do_not_save --end_epoch 1 --decay_start 1.0 --which_gpu 0

echo lvan-lw
python vat_ladder.py --logdir logs/test/ --id lvan-lw --model nlw --do_not_save --end_epoch 1 --decay_start 1.0 --which_gpu 0
